...
create table customers1 ( 
    customer1_id int primary key, customer1_name varchar(32), 
    city varchar(20), grade int, salesman_id int);
...
SELECT a.customer1_name AS "Customer Name", a.city, b.name AS "Salesman", b.commission FROM customers1 a  
INNER JOIN salesman b ON a.salesman_id=b.salesman_id;

SELECT a.customer1_name, a.city, a.grade, b.name AS "Salesman", b.city FROM customers1 a  
LEFT OUTER JOIN salesman b ON a.salesman_id=b.salesman_id WHERE a.grade<300  
ORDER BY a.customer1_id;
...
SELECT a.order_no, a.order_date, a.purchase_amount, b.customer_name AS "Customer Name", b.grade, c.name AS "Salesman", c.commission FROM orders a  
INNER JOIN customers1 b ON a.customer_id=b.customer1_id  
INNER JOIN salesman c ON a.salesman_id=c.salesman_id;
...
SELECT a.customer1_name AS "CustomerName", a.city, b.name AS "Salesman", b.commission FROM customers1 a  
INNER JOIN salesman b ON a.salesman_id=b.salesman_id;
